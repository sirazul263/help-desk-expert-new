      ...
      <div className="legal-hero">
        ...
        >
          ...
          <p className="hero-desc">
            These Terms govern your access to and use of HelpDeskXpert services.
            Please read them carefully before using our platform or engaging our
            agents.
          </p>
        ...
        <div className="legal-content">
          ...
          <div className="legal-section" id="acceptance">
            ...
            <p>
              ...
              (&quot;Client&quot;, &quot;you&quot;, &quot;your&quot;) and{" "}
              <strong>HelpDeskXpert Ltd.</strong> (&quot;HelpDeskXpert&quot;,
              &quot;we&quot;, &quot;us&quot;, &quot;our&quot;).
            </p>
            <p>
          ...
          <div className="legal-section" id="services">
            ...
            <h2>Our Services</h2>
            <p>
              HelpDeskXpert provides outsourced customer support agent services
              to SaaS and technology companies. Our services include, but are
              not limited to:
            </p>
            <ul>
              <li>
          ...
          <div className="legal-section" id="liability">
            ...
            <p>
              These limitations apply even if HelpDeskXpert has been advised of
              the possibility of such damages. Some jurisdictions do not allow
              certain limitations of liability, so these limitations may not
          ...
          <div className="legal-section" id="general">
            ...
            <p>
              ...
              constitute the entire agreement between you and HelpDeskXpert and
